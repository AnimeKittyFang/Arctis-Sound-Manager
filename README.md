...
| Arctis 7 / 7 2019 / Pro 2019 / Pro GameDAC | ✅ | 17 | $\color{royalblue}{\textbf{1260}}$, $\color{royalblue}{\textbf{12ad}}$, $\color{royalblue}{\textbf{1252}}$, $\color{royalblue}{\textbf{1280}}$ |
| Arctis 7+ / PS5 / Xbox / Destiny | ✅ | 35 | $\color{royalblue}{\textbf{220e}}$, $\color{royalblue}{\textbf{2212}}$, $\color{royalblue}{\textbf{2216}}$, 2236 |
| Arctis 9 Wireless | ✅ | 18 | $\color{royalblue}{\textbf{12c2}}$ |
| Arctis Pro Wireless | ✅ | 42 | $\color{royalblue}{\textbf{1290}}$, $\color{royalblue}{\textbf{1294}}$ |
| Arctis Nova Pro Wireless / X | ✅ | 335 | $\color{royalblue}{\textbf{12e0}}$, $\color{royalblue}{\textbf{12e5}}$, $\color{royalblue}{\textbf{225d}}$ |
| Arctis Nova Pro Wired / Xbox Wired | ✅ | 43 | $\color{royalblue}{\textbf{12cb}}$, $\color{royalblue}{\textbf{12cd}}$ |
| Arctis Nova Pro Omni | ✅ | 39 | $\color{royalblue}{\textbf{2290}}$ |
| Arctis Nova 3 | ✅ | 10 | $\color{royalblue}{\textbf{12ec}}$ |
| Arctis Nova 3P / 3X Wireless | ✅ | 28 | $\color{royalblue}{\textbf{2269}}$, $\color{royalblue}{\textbf{226d}}$ |
| Arctis Nova 5 / 5X | ✅ | 74 | $\color{royalblue}{\textbf{2232}}$, $\color{royalblue}{\textbf{2253}}$, $\color{royalblue}{\textbf{2255}}$, $\color{royalblue}{\textbf{2264}}$ |
| Arctis Nova 7 Gen 1 | ✅ | 45 | $\color{royalblue}{\textbf{2202}}$, $\color{royalblue}{\textbf{2206}}$, 223a, $\color{royalblue}{\textbf{227a}}$, $\color{royalblue}{\textbf{22a4}}$ |
| Arctis Nova 7 Gen 2 | ✅ | 161 | $\color{royalblue}{\textbf{22a1}}$, $\color{royalblue}{\textbf{227e}}$, $\color{royalblue}{\textbf{2258}}$, $\color{royalblue}{\textbf{229e}}$, $\color{royalblue}{\textbf{22a9}}$, $\color{royalblue}{\textbf{22a5}}$, $\color{royalblue}{\textbf{22ab}}$ |
| Arctis Nova 7P | ✅ | 18 | $\color{royalblue}{\textbf{220a}}$, $\color{royalblue}{\textbf{22a7}}$ |
| Arctis Nova Elite | ✅ | 22 | $\color{royalblue}{\textbf{2244}}$, 2249, $\color{royalblue}{\textbf{2270}}$ |
...
<!-- STATS:META:START -->
_Based on **941** unique users (**65663** anonymous data points) — last updated 2026-09-14_
<!-- STATS:META:END -->
...
| CachyOS | 🎯 AUR | 👥 393 |
| Arch Linux | 🎯 AUR | 👥 180 |
| Nobara Linux 44 (KDE Plasma Desktop Edition) | 🎯 COPR | 👥 53 |
| Fedora Linux 44 (KDE Plasma Desktop Edition) | 🎯 COPR | 👥 51 |
| Linux Mint 22.3 | 🎯 PPA | 👥 46 |
| Ubuntu 26.04 LTS | 🎯 PPA | 👥 23 |
| Pop!_OS 24.04 LTS | 🎯 PPA | 👥 21 |
| EndeavourOS | 🎯 AUR | 👥 21 |
| Ubuntu 26.04.1 LTS | 🎯 PPA | 👥 20 |
| Fedora Linux 44 (Workstation Edition) | 🎯 COPR | 👥 20 |
| Nobara Linux 43 (KDE Plasma Desktop Edition) | 🎯 COPR | 👥 14 |
| Omarchy | 🎯 AUR | 👥 13 |
| Garuda Linux | 🎯 AUR | 👥 11 |
| Ubuntu 24.04.4 LTS | 🎯 PPA | 👥 10 |
| Manjaro Linux | 🎯 AUR | 👥 8 |
| NixOS 26.11 (Zokor) | 📦 Source | 👥 7 |
| Bazzite | 📦 Source | 👥 7 |
| Fedora Linux 44 (Forty Four) | 🎯 COPR | 👥 4 |
| Debian GNU/Linux 13 (trixie) | 🎯 PPA | 👥 4 |
| SteamOS | 📦 Source | 👥 3 |
| PikaOS 4 | 📦 Source | 👥 3 |
| NixOS 26.05 (Yarara) | 📦 Source | 👥 3 |
| Fedora Linux 43 (KDE Plasma Desktop Edition) | 🎯 COPR | 👥 3 |
| Artix Linux | 🎯 AUR | 👥 3 |
| Zorin OS 18.1 | 🎯 PPA | 👥 2 |
| Ultramarine Linux 44 (Plasma Edition) | 📦 Source | 👥 2 |
| Linux Mint 22.2 | 🎯 PPA | 👥 2 |
| Ubuntu 25.10 | 🎯 PPA | 👥 1 |
| Ubuntu 24.04.5 LTS | 🎯 PPA | 👥 1 |
| SpellOS 2xev | 📦 Source | 👥 1 |
...
| Headset | Installs |
|---|---|
| Arctis Nova Pro Wireless | 335 |
| Arctis Nova 7 (Gen 2) | 161 |
| Arctis Nova 5 Wireless | 74 |
| Arctis Nova 7 (Gen 1) | 45 |
| Arctis Nova Pro Wired | 43 |
| Arctis Pro Wireless | 42 |
| Arctis Nova Pro Omni | 39 |
| Arctis 7+ | 35 |
| Arctis Nova Elite | 22 |
| Arctis Nova 3 Wireless | 21 |
| Arctis GameBuds | 19 |
| Arctis 9 Wireless | 18 |
| Arctis 7/Pro Gaming | 17 |
| Arctis Nova 3 | 17 |
| Arctis Nova 7P (Gen 2) | 13 |
| Arctis 1/7X/7P Wireless | 6 |
...
| CachyOS | 393 |
| Arch Linux | 180 |
| Nobara Linux 44 (KDE Plasma Desktop Edition) | 53 |
| Fedora Linux 44 (KDE Plasma Desktop Edition) | 51 |
| Linux Mint 22.3 | 46 |
| Ubuntu 26.04 LTS | 23 |
| Pop!_OS 24.04 LTS | 21 |
| EndeavourOS | 21 |
| Ubuntu 26.04.1 LTS | 20 |
| Fedora Linux 44 (Workstation Edition) | 20 |
...
| [hotdoghotdog5](https://github.com/hotdoghotdog5) | Reverse-engineered the Arctis Nova Pro Omni's real protocol on hardware (a Windows GG capture, SteelSeries' own device specification, and Linux writes confirmed by reading values back off the base station) — sidetone, the volume limiter, ANC and its level, transparency, mic volume and LED, the OLED screen, the auto-off timer, and accurate battery/charging/Bluetooth status all came from this ([#70](https://github.com/loteran/Arctis-Sound-Manager/issues/70), [#147](https://github.com/loteran/Arctis-Sound-Manager/issues/147)) |
| [rhavinx](https://github.com/rhavinx) | USB captures of the Arctis Nova 3P / 3X Wireless that pinned down ChatMix, mic-mute, battery, connection and charging events, leading to the family's own dedicated device profile ([#149](https://github.com/loteran/Arctis-Sound-Manager/issues/149)) |
| [Svenum](https://github.com/Svenum) | Fixed a Nix flake evaluation error and a `LADSPA_PATH` override needed for `filter-chain` (PR [#83](https://github.com/loteran/Arctis-Sound-Manager/pull/83), #79) |
| [nobodys-tools](https://github.com/nobodys-tools) | Contributed the missing default HRIR seeding for module-only installs (#79) and the fix for the virtual-microphone hijack bug ([#185](https://github.com/loteran/Arctis-Sound-Manager/issues/185)); found and diagnosed precisely the Home page's endless background refresh ([#182](https://github.com/loteran/Arctis-Sound-Manager/issues/182)) |
| [jsuvanto](https://github.com/jsuvanto) | Diagnosed the USB-permissions boot-time race on Nobara down to its root cause, alongside DefactoCasual (discussion [#140](https://github.com/loteran/Arctis-Sound-Manager/discussions/140)) |
...
| [kevinpbaker](https://github.com/kevinpbaker) | Traced the Arctis Nova Pro Omni's dead ChatMix knob to a firmware race — the base station abandons its Game/Chat mode switch if the next command lands within a few milliseconds — and fixed it with a settle pause in `device_init` ([#245](https://github.com/loteran/Arctis-Sound-Manager/pull/245)); diagnosed and fixed the wake-from-suspend deadlock that regressed in 1.4.25, from a `py-spy` dump of the hung daemon ([#251](https://github.com/loteran/Arctis-Sound-Manager/pull/251)) |
